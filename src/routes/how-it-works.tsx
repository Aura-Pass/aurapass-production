    ...
    <PageWrapper>
      <div className="bg-background">
        <div className="mx-auto max-w-5xl px-4 py-12 md:px-6 md:py-16">
          ...
          <h2 className="mt-10 text-xl font-semibold text-foreground">For attendees</h2>
          ...
          <h2 className="mt-12 text-xl font-semibold text-foreground">For organisers</h2>
          ...
          <div className="mt-12 flex flex-wrap gap-3">
            ...
            <Link
              to="/events"
              className="rounded-lg border border-border bg-background px-5 py-3 text-sm font-semibold text-foreground hover:border-primary"
            >
              Discover events
            </Link>
          </div>
